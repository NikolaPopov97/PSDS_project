...
HD_PWD='C:/Users/user/PSDS_project/VHDL_models/phaser_ip/ip_repo/edit_phaser_ip_v1_0.runs/impl_2'
cd "$HD_PWD"
...
EAStep vivado -log phaser_ip_v1_0.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source phaser_ip_v1_0.tcl -notrace
