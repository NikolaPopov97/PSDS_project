...
HD_PWD='C:/Users/user/PSDS_project/VHDL_models/phaser_datapath/dual_allpass/dual_allpass.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log dual_allpass.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source dual_allpass.tcl
