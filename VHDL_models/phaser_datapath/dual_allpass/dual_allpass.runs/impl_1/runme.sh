...
HD_PWD='C:/Users/user/PSDS_project/VHDL_models/phaser_datapath/dual_allpass/dual_allpass.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log dual_allpass.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source dual_allpass.tcl -notrace
