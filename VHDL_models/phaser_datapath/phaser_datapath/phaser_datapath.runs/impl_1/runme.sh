...
HD_PWD='C:/Users/milut/OneDrive/Documents/GitHub/PSDS_project/VHDL_models/phaser_datapath/phaser_datapath/phaser_datapath.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log phaser_datapath.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source phaser_datapath.tcl -notrace
